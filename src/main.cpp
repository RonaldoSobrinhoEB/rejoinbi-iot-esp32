...
String accessPointPassword() {
  // A senha pode ser lida diretamente do SSID exibido na busca de Wi-Fi:
  // RejoinBI-IOT-34E3EC -> RJ34E3EC (8 caracteres, mínimo exigido pelo WPA2).
  return "RJ" + chipSuffix();
}
